...
- Für Löschung/Offboarding liegt eine noch nicht ausgerollte private V1-Grundlage mit idempotenter Warteschlange, Freigabestatus, Legal Hold und rein lesendem Mitarbeiter-Dry-Run vor. Der vorbereitete Edge-Endpunkt prüft aktive OWNER/ADMIN und verlangt `aal2` für das Einstellen eines Auftrags. Ein fiktiver Mandantentest deckt Fremdmandant, falsche Rolle und fehlendes MFA ab. Die V1 plant Datenbank-, Auth-, Storage- und Push-Schritte, führt aber bewusst noch keine Löschung aus.
