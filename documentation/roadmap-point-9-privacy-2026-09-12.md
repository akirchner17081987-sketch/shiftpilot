...
- Für Löschung/Offboarding sind V1–V13 mit idempotenter Warteschlange, Kunden-Fristprofil, Legal Holds, Zwei-Personen-/Ein-OWNER-Freigabe, vollständiger Vorschau, Auth-/Storage-Worker, Langfristredaktion und 15-Minuten-Zeitplan produktiv aktiv. Für den Betrieb mit genau einem echten OWNER gilt regulär `SOLE_OWNER_DELAYED`: zwei AAL2-Bestätigungen aus unterschiedlichen Sitzungen, 24 Stunden Abkühlfrist, 7 Tage Bestätigungsfenster, unveränderte Vorschau und harte Sperren gegen die Löschung des einzigen OWNER oder des Mandanten. Die fachlichen Fristen für Arbeitszeit, QR, Monatsabschlüsse und DATEV-Audit sind am 18.09.2026 auf 6 Jahre festgelegt. Das versehentlich aktivierte V1 mit 3 Jahren Zeitnachweis wurde am 18.09.2026 um 00:41:14 UTC durch die ausdrücklich freigegebene, einmalige und auditierte Korrekturmigration atomar widerrufen und durch V2 mit 6/6/6 Jahren ersetzt. Die normale AAL2-/24-Stunden-Regel blieb unverändert. Die physische Löschung/Anonymisierung fälliger Zeit-/QR-Nachweise ist vor Eintritt der ersten Sechsjahresfälligkeit als eigener Datenklassenpfad zu ergänzen.
...
2. Vor der ersten Sechsjahresfälligkeit den kontrollierten Lösch-/Anonymisierungspfad für eigentliche Arbeitszeit- und QR-Nachweise implementieren und testen. Auth- und Storage-Löschung bleiben standardmäßig ausgeschaltet.
...
Teilpunkt 9.3 – Lösch- und Aufbewahrungskonzept: 🟢 **ABGESCHLOSSEN am 18.09.2026.** Das aktive V2-Fristprofil verwendet 6 Jahre für Arbeitszeit-/QR-Nachweise, Monats-Snapshots und DATEV-Audit; V1 ist revisionssicher widerrufen und die Umstellung vollständig auditiert.
