...
- Für Löschung/Offboarding sind V1–V13 mit idempotenter Warteschlange, Kunden-Fristprofil, Legal Holds, Zwei-Personen-/Ein-OWNER-Freigabe, vollständiger Vorschau, Auth-/Storage-Worker, Langfristredaktion und 15-Minuten-Zeitplan produktiv aktiv. Für den Betrieb mit genau einem echten OWNER gilt `SOLE_OWNER_DELAYED`: zwei AAL2-Bestätigungen aus unterschiedlichen Sitzungen, 24 Stunden Abkühlfrist, 7 Tage Bestätigungsfenster, unveränderte Vorschau und harte Sperren gegen die Löschung des einzigen OWNER oder des Mandanten. Die fachlichen Fristen für Arbeitszeit, QR, Monatsabschlüsse und DATEV-Audit sind am 18.09.2026 auf 6 Jahre festgelegt. V1 mit 3 Jahren Zeitnachweis wurde über eine bereits geöffnete alte Ansicht bestätigt und ist fachlich überholt. V13 erlaubt die sichere Nachfolgerfreigabe: V1 bleibt während der V2-Abkühlfrist aktiv und wird erst bei erfolgreicher zweiter AAL2-Bestätigung atomar widerrufen. Die eigentliche V2-Doppelbestätigung bleibt Betreiberaktion. Die physische Löschung/Anonymisierung fälliger Zeit-/QR-Nachweise ist vor Eintritt der ersten Sechsjahresfälligkeit als eigener Datenklassenpfad zu ergänzen.
...
2. Fristprofil V2 betrieblich freigeben: Die 6-Jahres-Entscheidung und der sichere V12-Ersatzpfad sind umgesetzt. Im Adminbereich V1 AAL2-geschützt durch V2 ersetzen und V2 nach mindestens 24 Stunden in einer neuen MFA-Sitzung zweitbestätigen. Auth- und Storage-Löschung bleiben standardmäßig ausgeschaltet. Vor der ersten Sechsjahresfälligkeit den kontrollierten Lösch-/Anonymisierungspfad für eigentliche Arbeitszeit- und QR-Nachweise implementieren und testen.
