...
| Löschfreigabe im Ein-OWNER-Betrieb | `ein-owner-loeschfreigabe-2026-09-14.md`, V6-Migration, 22-Fälle-DB-Test, Lösch-/Aufbewahrungskonzept | kompensierende Betriebsregel und technische V6-Vorbereitung mit zwei AAL2-Sitzungen, 24-Stunden-Abkühlfrist, 7-Tage-Fenster, Vorschauhash und Sperre des einzigen OWNER | Datenbankausführung auf Wegwerf-Branch, Auth-/Storage-Worker und Produktivfreigabe stehen aus |
