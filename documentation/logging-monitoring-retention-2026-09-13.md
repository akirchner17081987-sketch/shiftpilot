...
|---|---|---|---|
| `public.audit_events` | mandantenbezogene fachliche und sicherheitsrelevante Ereignisse; Akteur, Rolle, Entität, Zeitpunkt sowie begrenzte Alt-/Neu-/Metadaten | RLS, `FORCE ROW LEVEL SECURITY`, unveränderliche Ereignisidentität und V11-Langfristredaktion technisch aktiv; V2-Aktivierung durch `RETENTION_PROFILE_CONTROLLED_ACTIVATION` revisionssicher nachgewiesen | V2 mit 6 Jahren für Zeitnachweise, Monats-Snapshots und DATEV-Audit ist seit 18.09.2026 aktiv; V1 ist widerrufen. Die einmalige Sofortkorrektur änderte die reguläre AAL2-/24-Stunden-Regel für zukünftige Profiländerungen nicht. |
