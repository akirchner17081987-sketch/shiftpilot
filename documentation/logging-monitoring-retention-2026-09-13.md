...
| IONOS Deploy Now | Deployment- und Laufzeitverfügbarkeit der statischen PWA | IONOS-Vorschau produktionsnah bereitgestellt; synthetischer Check prüft Startseite, Security Header, PWA-Manifest, Service Worker und Datenschutzseite | IONOS dokumentiert Deploy Now als eigenes Produkt mit GitHub-Deployment, SiteAnalytics und GitHub-basierter Backupgrenze; eine konkrete Deploy-Now-Rohlog-Aufbewahrungsfrist wurde in der offiziellen Produkt-/Hilfedokumentation nicht gefunden. Allgemeine Webhosting-Logfristen werden nicht übertragen. |
...
6. Für IONOS Deploy Now wird keine Aufbewahrungsdauer aus einer allgemeinen Webhosting-Dokumentation übernommen. Die offizielle Deploy-Now-Hilfe grenzt das Produkt ausdrücklich von klassischem Web Hosting ab; eine konkrete Rohlog-Aufbewahrungsfrist bleibt daher als Anbieterbestätigung offen.
...
- ☐ IONOS-Deploy-Now-Logzugriff und produktspezifische Frist durch Anbieter/Dashboard belastbar bestätigt
...
Status: 🟡 **SYNTHETISCHES IONOS-/SUPABASE-MONITORING IMPLEMENTIERT, POSITIVTEST 5/5 UND NEGATIV-ALARMPFAD BESTANDEN; STÜNDLICHER CONDITION-WATCH AKTIV; SUPABASE-PRO-LOGFENSTER DOKUMENTIERT. OFFEN SIND NOCH DEFAULT-BRANCH-ZEITPLAN, BACKUP-ALARM, IONOS-DEPLOY-NOW-LOGBESTÄTIGUNG, VERTRETUNG/BEREITSCHAFTSREGELUNG UND WEITERE ANBIETER-/WORKFLOW-NACHWEISE.**
