...
(function(){
  ...
  function css(){
    ...
    const s=document.createElement('style');s.id='sfAbsMgrV2Css';s.textContent=`
      ...
      .sf-abs-mgr-v2.clear{border-color:#23705d;background:linear-gradient(180deg,#102d28,#0d2521)}.sf-abs-mgr-v2.clear .sf-abs-mgr-v2-count{background:#17654f;color:#83e2cb}.sf-abs-mgr-v2.clear .sf-abs-mgr-v2-empty{border-color:#286b5b;background:#0e2b25;color:#83e2cb}
  ...
  async function render(force=false){
    ...
    try{
      ...
      box.classList.toggle('clear',!rows.length);
