...
(function(){
  ...
  const append=(file,next)=>{if(present(file)){next();return}const s=document.createElement('script');const version=file==='assets/supabase-time-account-holidays-v1.js'?'20260911-saxony1':'20260906-timeaccount1';s.src=file+'?v='+version;s.onload=next;s.onerror=()=>{console.error('SchichtFunk-Modul konnte nicht geladen werden:',file);next()};document.body.appendChild(s)};
  const loadManager=()=>{
