...
(function(){
  ...
  const append=(file,next)=>{if(present(file)){next();return}const s=document.createElement('script');s.src=file+'?v=20260906-timeaccount1';s.onload=next;s.onerror=()=>{console.error('SchichtFunk-Modul konnte nicht geladen werden:',file);next()};document.body.appendChild(s)};
  const loadManager=()=>{
