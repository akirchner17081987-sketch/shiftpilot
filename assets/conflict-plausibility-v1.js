...
(function(){
  ...
  const append=(file,next)=>{if(present(file)){next();return}const s=document.createElement('script');const version=['assets/supabase-auth-v1.js','assets/supabase-data-v1.js','assets/supabase-schedule-reset-v1.js','assets/supabase-time-month-close-v1.js','assets/datev-lodas-export-v1.js','assets/supabase-qr-terminal-admin-v1.js'].includes(file)?'20260917-aal2-stepup1':file==='assets/supabase-time-tracking-v1.js'?'20260912-plan-default1':file==='assets/supabase-time-account-holidays-v1.js'?'20260911-saxony1':file==='assets/time-month-picker-v1.js'?'20260912-monthfix2':'20260906-timeaccount1';s.src=file+'?v='+version;s.onload=next;s.onerror=()=>{console.error('SchichtFunk-Modul konnte nicht geladen werden:',file);next()};document.body.appendChild(s)};
  const loadManager=()=>{
