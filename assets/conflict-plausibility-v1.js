...
(function(){
  ...
  const append=(file,next)=>{if(present(file)){next();return}const s=document.createElement('script');const version=['assets/supabase-absence-employee-v3.js','assets/employee-portal-workspace-v2.js'].includes(file)?'20260912-acceptance1':file==='assets/supabase-time-tracking-v1.js'?'20260912-plan-default1':file==='assets/supabase-time-account-holidays-v1.js'?'20260911-saxony1':file==='assets/time-month-picker-v1.js'?'20260912-monthfix2':file==='assets/privacy-retention-ui-v1.js'?'20260916-retention1':'20260906-timeaccount1';s.src=file+'?v='+version;s.onload=next;s.onerror=()=>{console.error('SchichtFunk-Modul konnte nicht geladen werden:',file);next()};document.body.appendChild(s)};
  const loadManager=()=>{
