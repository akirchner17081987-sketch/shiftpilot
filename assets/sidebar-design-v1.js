...
(function(){
  ...
  .brand.app-brand{min-height:58px;margin:0 3px 13px;padding:0 8px 12px!important;border-bottom:1px solid rgba(94,143,173,.13)}
  .brand.app-brand .app-brand-img{width:178px!important;max-height:55px!important;filter:none}
  ...
  @media(max-width:1100px){.brand.app-brand .app-brand-img{width:158px!important}.nav button{padding-left:8px;padding-right:8px}.company-card{grid-template-columns:35px minmax(0,1fr) 18px}.company-icon{width:35px;height:35px}}
  @media(max-width:700px){#nav:before,.side-bottom:before{display:none}.sidebar{padding:12px 7px}.brand.app-brand{min-height:48px;padding:0 1px 10px!important}.brand.app-brand .app-brand-img{width:48px!important;height:46px!important;object-fit:cover!important;object-position:left!important}.nav button{justify-content:center;padding:7px}.nav button>span:first-child{width:32px;height:32px;flex-basis:32px}.nav button.active:after{right:5px}.user-row{padding:7px;justify-content:center}}
  `;
  function enhance(){
